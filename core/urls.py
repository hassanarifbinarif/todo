...
urlpatterns = [
    ...
    path('get-search-properties/', views.get_search_properties, name='get_search_properties'),
    path('property-listing/<int:pk>/', views.property_listing, name='property_listing'),
